...
interface CommandLineParser {
    class ParseException extends Exception {
        ParseException(Flag flag, int pos, String message) {
    ...
    class Flag {
         ...
         * there is none.
         */
        Flag(char shortFlag, String longFlag) {
    ...
    Flag addFlag(char shortFlag);
    Flag addFlag(String longFlag);
    Flag addFlag(char shortFlag, String longFlag);
    Flag getFlag(char shortFlag);
    Flag getFlag(String longFlag);
     ...
     */
    void setArgCount(Flag flag, int argc);
     ...
     */
    ParseResult parse(String[] args) throws ParseException;
